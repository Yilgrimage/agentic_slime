...
RESOLVED_TRAIN_EXTRA_KEYS=(
  ...
  CUSTOM_RM_PATH GROUP_RM RM_TYPE RM_URL REWARD_KEY EVAL_REWARD_KEY LOG_REWARD_CATEGORY
  LR_DECAY_ITERS
...
RESOLVED_LAUNCH_KEYS=(
  ...
  WANDB_RUNTIME WANDB_PACK_NAME WANDB_PACK_PATH
  ENV_NAME ENV_CONFIG AGENT_ENV_DATA_DIR MODEL_PROFILE TRAIN_PROFILE TRAIN_ADAPTER RESOLVED_TRAIN_ENV
