...
APPWORLD_RECREATE=${APPWORLD_RECREATE:-0}
REVISION=${APPWORLD_REVISION:-appworld-${APPWORLD_VERSION}}
...
runtime_pack_prepare_prefix "${ENV_PREFIX}" "${APPWORLD_RECREATE}"
...
python -m pip install "appworld==${APPWORLD_VERSION}" conda-pack
