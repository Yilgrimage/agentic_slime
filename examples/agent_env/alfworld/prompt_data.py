...
def main():
    ...
    if args.num_tasks is None and task_rows is None:
    ...
    for split in args.splits:
        split_task_rows = _filter_available_task_rows(task_rows, data_dir, split) if task_rows is not None else None
